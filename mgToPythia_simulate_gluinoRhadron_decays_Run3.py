...
process.load('SimGeneral.MixingModule.mix_2023_25ns_RunIII2023Summer24_PoissonOOTPU_cfi')
...
options.register('ctau', '0p1',
    VarParsing.multiplicity.singleton,
    VarParsing.varType.string,
    "ctau of the R-hadron in mm"
)

options.register('quarkDecay', 'light',
    VarParsing.multiplicity.singleton,
    VarParsing.varType.string,
    "What quarks the R-hadron can decay to: 'light' or 'heavy'"
)
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring(f'root://cmseos.fnal.gov//store/user/avendras/HSCP/gridpack_output/tarballs/RunIII/gluinos/HSCPgluino_M-{options.mass}/HSCPgluino_M-{options.mass}_xqcut100_el9_amd64_gcc11_CMSSW_13_2_9_xqcut100_tarball.tar.xz '),
...
process.generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    SLHAFileForPythia8 = cms.string(f'SimG4Core/CustomPhysics/data/gluinoRhadron_{options.mass}GeV_1300GeVchi10_{options.ctau}mm_{options.quarkDecay}QuarkDecay_splitSUSY.txt'),
